...
| [`image_compression_with_kmeans`](https://github.com/Federico-CM/ml_experiments/tree/main/projects/image_compression_with_kmeans) | Unsupervised learning | K-means (from scratch), color quantization, pixel clustering | Python |
