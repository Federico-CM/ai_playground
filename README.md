...
A portfolio of self-contained machine learning experiments spanning supervised learning, unsupervised learning, NLP, dimensionality reduction, and LLM integration. Projects are implemented in Python and R.
...
| Software engineering | Python packaging, pyproject.toml, pytest, GitHub Actions, multi-version CI |
...
|---|---|---|---|
| [`ifood_marketing_campaign_prediction`](https://github.com/Federico-CM/ml_experiments/tree/main/projects/ifood_marketing_campaign_prediction) | End-to-end analysis | EDA, feature engineering, logistic regression, random forest | Python |
| [`llm_chatbot`](https://github.com/Federico-CM/ml_experiments/tree/main/projects/chatbot_implementation_chatGPTAPI) | LLM / API integration | OpenAI API, prompt engineering, conversation state management | Python |
| [`image_compression_with_kmeans`](https://github.com/Federico-CM/ml_experiments/tree/main/projects/image_compression) | Unsupervised learning | K-means (from scratch), color quantization, pixel clustering | Python |
...
| [`customer_segmentation_with_kmeans`](https://github.com/Federico-CM/ml_experiments/tree/main/projects/customer_segmentation_with_kmeans) | Unsupervised learning | K-means, customer profiling, elbow method, cluster interpretation | Python & R |
